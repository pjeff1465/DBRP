...
\begin{enumerate}
    ...
    This property ensures redundancy exists when storing information across multiple locations. Meaning, potential information overlaps between components, which ensures recovery mechanisms.
    \begin{figure}[htbp]  % 'h' places the figure "here" (can be adjusted)
        \centering
