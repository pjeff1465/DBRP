...
\begin{enumerate}
    ...
    \begin{figure}[htbp]  % 'h' places the figure "here" (can be adjusted)
        \centering
        \includegraphics[width=\textwidth]{subadditivity.jpeg}  % Adjust width as needed
...
\\
But in order for holographic quantum state to be valid it \textbf{must} satisfy the following property:
\vspace{0.3cm}
